...
export default function AssignedOrderDetailsPage({ slug }: { slug: string }) {
  ...
  const handleUpdateStatus = useCallback(async () => {
    if (!adminOrder || selectedStatus === adminOrder.status || isUpdating)
      return;
    ...
    try {
      ...
      const res = await vendorOrderService.updateVendorOrderStatus(
        slug,
        payload,
      );
            ...
            <div className="lg:col-span-2 p-4 md:p-6 lg:p-8 bg-white space-y-6">
              ...
              <section aria-labelledby="order-items-heading">
                <h3
                  ...
                  className="text-lg md:text-xl font-bold text-slate-900 mb-5"
                >
                  Order Items
                </h3>
