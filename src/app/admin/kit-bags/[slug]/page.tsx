  ...
  const calculations = useMemo(() => {
    ...
    data.items.forEach((item) => {
      ...
      if (item.variant.previous_price) {
        savings +=
          (item.variant.previous_price - item.variant.price) * item.quantity;
      }
    });
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <h1
                  className={cn(
                    "text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold bg-gradient-to-r from-primary to-[#6b4fc0] bg-clip-text text-transparent",
                    "capitalize",
                  )}
                >
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              >
                <Calendar
                  className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1.5 sm:mr-2"
                  aria-hidden="true"
                />
                {data?.created_at}
              </Badge>
          ...
          <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            >
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                ...
                >
                  <div
                    className="w-1 h-4 sm:h-5 rounded-full bg-primaryColor flex-shrink-0"
                    aria-hidden="true"
                  />
                  Your Items
                </h2>
