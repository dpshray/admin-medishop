...
export default function VendorClientPage({slug}: VendorClientPageProps) {
    ...
    const memoizedData = useMemo(() => {
        ...
        const verificationStatus = GetVerificationStatus(vendor.vendor_details.account_status);
    ...
    const statCards = [
        {
            ...
            iconColor: vendor_details.account_status ? "text-green-600" : "text-red-600"
        },
        {
            ...
            iconColor: vendor_details.email_verified ? "text-blue-600" : "text-amber-600"
        },
        {
            icon: FileText,
            label: "Documents",
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/10">
            <div className="container mx-auto px-4 py-6 sm:py-8 max-w-7xl">
                    ...
                    <CardContent className="p-4 sm:p-6 lg:p-8">
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col sm:flex-row items-start gap-4">
                                <Avatar
                                    className="h-16 w-16 sm:h-20 sm:w-20 border-2 border-slate-200 shadow-md flex-shrink-0">
                                    <AvatarFallback
                                        className="text-lg sm:text-xl font-bold bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-base sm:text-lg font-semibold text-slate-700 mb-1">{vendor.name}</p>
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        <StatusBadge status={vendor_details.account_status ? STATUS_TYPE.ACTIVE: STATUS_TYPE.INACTIVE}/>
                                        <Badge
                                            variant={vendor_details.email_verified ? "secondary" : "outline"}
                                            className={cn(
                                                "px-3 py-1",
                                        ...
                                        >
                                            ...
                                            {vendor_details.email_verified ? "Email Verified" : "Email Unverified"}
                                        </Badge>
                                    </div>
                                </div>
                ...
                <Tabs defaultValue={tabs[0].value} className="w-full">
                    <TabsList
                        className="w-full mb-6 bg-white border shadow-sm p-1 h-auto rounded-lg grid grid-cols-2 sm:grid-cols-4 gap-1">
                                    ...
                                    <CardContent className="p-4 sm:p-6">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    className="bg-slate-50 p-4 sm:p-5 rounded-lg border border-slate-200">
                                    ...
                                    <CardContent className="p-4 sm:p-6">
                                        ...
                                        <div className="bg-purple-50 p-4 sm:p-6 rounded-lg border border-purple-100">
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    className="bg-white p-4 sm:p-5 rounded-lg border border-purple-200 shadow-sm">
                                ...
                                <CardContent className="p-4 sm:p-6">
                                    ...
                                    <div className="space-y-5">
                                        <div className="flex items-start gap-4 pb-5 border-b border-slate-200">
                                            <Avatar
                                                className="h-14 w-14 sm:h-16 sm:w-16 border-2 border-slate-200 shadow-sm flex-shrink-0">
                                                <AvatarFallback
                                                    className="text-base sm:text-lg font-bold bg-gradient-to-br from-blue-600 to-indigo-600 text-white">
                                                    {getInitials(vendor.name)}
                                                </AvatarFallback>
                                            </Avatar>
                                            <div className="flex-1 min-w-0">
                                                <h3 className="text-base sm:text-lg font-bold text-slate-900 break-words">{vendor.name}</h3>
                                        ...
                                        <nav className="space-y-3" aria-label="Contact methods">
                                            ...
                                            >
                                                <div
                                                    className="w-10 h-10 sm:w-11 sm:h-11 bg-blue-600 rounded-lg flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform flex-shrink-0">
                                                    <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-white"
                                                          aria-hidden="true"/>
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-0.5">
                                                        <p className="text-xs text-blue-900/70 font-semibold uppercase tracking-wide">Email</p>
                                                        {vendor_details.email_verified && (
                                            ...
                                            >
                                                <div
                                                    className="w-10 h-10 sm:w-11 sm:h-11 bg-green-600 rounded-lg flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform flex-shrink-0">
                    ...
                    <TabsContent value="business" className="space-y-6 focus-visible:outline-none">
                        <Card className="shadow-md border bg-white">
                            <CardContent className="p-4 sm:p-6">
                                <div className="flex items-center gap-3 mb-6">
