    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 print:bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
                <div
                    className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8 print:hidden">
                    <div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <Button
                            variant="outline"
                            size="sm"
                            className="gap-2 text-xs sm:text-sm border-2 hover:border-primaryColor/40 transition-all h-9 sm:h-10"
                        >
                ...
                <div
                    ref={printRef}
                    className="bg-card rounded-2xl shadow-lg border-2 hover:border-primaryColor/30 transition-all overflow-hidden"
                >
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div className="flex items-center gap-3 sm:gap-4">
                                    <div
                                        className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl bg-white shadow-md flex items-center justify-center flex-shrink-0 border-2 border-primaryColor/10">
                        ...
                        <div className="lg:col-span-8 p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <div
                                        className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-gradient-to-r from-primaryColor/5 to-purple-50/30 border-2 border-primaryColor/10 hover:border-primaryColor/30 hover:shadow-md transition-all">
                                        <Avatar
                                            className="w-10 h-10 sm:w-12 sm:h-12 shadow-md bg-primaryColor ring-2 ring-primaryColor/20">
                                            <AvatarFallback
                                                className="text-white font-bold text-sm sm:text-base bg-primaryColor">
                                                {vendorOrder.name.charAt(0).toUpperCase()}
                                            </AvatarFallback>
                                        </Avatar>
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div
                                                ...
                                                <a
                                                    ...
                                                    className="hover:text-primaryColor transition-colors truncate font-medium"
                                                >
                                                    {vendorOrder.email}
                                                </a>
                                            </div>
                        ...
                        <div className="lg:col-span-4 p-4 sm:p-6 lg:p-8 space-y-6 bg-muted/20">
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        <div
                                            className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-white shadow-sm flex items-center justify-center flex-shrink-0 border border-primaryColor/20">
                                            <User className="w-4 h-4 sm:w-5 sm:h-5 text-primaryColor"/>
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs text-muted-foreground mb-1 font-medium">Customer
                                                Name</p>
                          ...
                          {FormatCurrency(vendorOrder.price)}
                                            ...
                                            <div className="flex justify-between pt-2">
                                                <span
                                                    className="text-base sm:text-lg font-bold text-foreground">Total</span>
                                                <span className="text-lg sm:text-xl font-bold text-primaryColor">
                          {FormatCurrency(vendorOrder.price)}
                        </span>
                                            </div>
                                        </div>
