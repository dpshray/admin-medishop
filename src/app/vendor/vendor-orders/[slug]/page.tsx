            ...
            "packageItems": [
                {
                    ...
                    "subtotal": 250,
                    "order_item_assigned_to": null,
                    "batch_number": ["7345902345000"]
                },
                {
                    "order_item_id": 32,
                    "item_name": "Package Product 2",
                    "type": "PRODUCT",
                    "prescription_required": false,
                    "quantity": 1,
                    "price": 250,
    ...
    return (
        <div className="min-h-screen bg-slate-50 print:bg-white">
            <div className="max-w-[1400px] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-6 lg:py-8">
                <header
                    className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-6 print:hidden">
                    <div className="space-y-1">
                        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900">Order
                            Details</h1>
                        <p className="text-xs sm:text-sm md:text-base text-slate-600">Manage and track order
                            information</p>
                    </div>
                    ...
                    <div className="p-4 md:p-6 lg:p-8 bg-slate-50">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            <div className="flex items-start gap-3">
                                <div
                                    className="w-14 h-14 md:w-16 md:h-16 rounded-lg bg-primaryColor flex items-center justify-center">
                        ...
                        <div className="lg:col-span-2 p-4 md:p-6 lg:p-8 bg-white space-y-6">
                            <section>
                                ...
                                <div className="space-y-4">
                                    {staticOrder.ordered_items.map((item: VendorOrderedItem, index: number) => (
                            ...
                            <section>
                                ...
                                <div className="flex items-center gap-4 p-4 rounded-lg bg-slate-50">
                                    <Avatar className="w-12 h-12 bg-primaryColor">
                                        <AvatarFallback
                                            className="text-white font-bold">{customerInitial}</AvatarFallback>
                                    </Avatar>
                                    <div className="min-w-0">
                                        <p className="font-bold text-lg text-slate-900 break-words">{staticOrder.name}</p>
                                        <div className="flex items-center gap-2 text-sm text-slate-600 mt-1">
                                            <Mail className="w-4 h-4"/>
                                            <a href={`mailto:${staticOrder.email}`}
                                               className="hover:text-primaryColor hover:underline break-all">{staticOrder.email}</a>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-50">
                                        <div
                                            className="w-10 h-10 rounded-lg bg-primaryColor/10 flex items-center justify-center">
                                    ...
                                    <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-50">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <address
                                                className="font-bold text-base text-slate-900 not-italic break-words">{staticOrder.address}</address>
                                            {hasCoordinates &&
                                                <p className="text-sm text-slate-500 mt-2 font-mono break-all bg-white px-2 py-1 rounded">{coordinatesText}</p>}
                                        </div>
                                    </div>
                                </div>
                            </section>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3 p-4 rounded-lg bg-slate-50">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="font-bold text-base text-slate-900 uppercase">{staticOrder.payment_method}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-slate-50 rounded-lg p-6">
                                        <dl className="space-y-3">
                                            ...
                                            <div className="flex justify-between pt-2">
                                                ...
                                                <dd className="text-xl lg:text-2xl font-bold text-primaryColor">{FormatCurrency(staticOrder.price)}</dd>
                                            </div>
                                        </dl>
                                    </div>
                                </div>
