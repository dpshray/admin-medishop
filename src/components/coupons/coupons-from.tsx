...
import { AlertCircle, Loader2, Percent, Tag, TicketPercent } from "lucide-react"
...
export default function CouponForm({ mode = "create", slug, open, onCloseAction, onSuccessAction }: CouponFormProps) {
    ...
    const onSubmit = useCallback(
        async (data: FieldValues) => {
            ...
            if (mode === "create") {
                ...
                const res = await couponService.updateCoupon(slug as string, data as UpdateCoupon)
