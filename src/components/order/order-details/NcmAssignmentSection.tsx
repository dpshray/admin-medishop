...
const NcmAssignmentSection = memo(({
    ...
    const { mutate: assignNcm, isPending } = userRole === "vendor"
        ? vendorMutation
        : adminMutation
    ...
    return (
        <section className="space-y-3" aria-labelledby="ncm-assignment-heading">
            ...
            >
                <Truck className="h-4 w-4 sm:h-5 sm:w-5 text-purple-600" aria-hidden="true" />
            ...
            <div className="border rounded-lg overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-purple-50/50 to-primary/5 px-4 py-3 border-b border-slate-200 flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-slate-700">Delivery &amp; Courier Details</span>
                </div>
                ...
                {!isNcmAssigned ? (
                    <div className="p-4 space-y-4 bg-purple-50/20">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            <SearchSelectField
                                ...
                                value={branchOptions.find(b => b.label === fbranchValue)?.value ?? ""}  
                            />
                            ...
                            <SearchSelectField
                                ...
                                value={branchOptions.find(b => b.label === tbranchValue)?.value ?? ""}  
                            />
                        ...
                        <div className="flex justify-end pt-1">
                            <Button
                                ...
                                size="sm"
                            >
                                <Truck className="h-3 w-3 sm:h-4 sm:w-4 mr-1" aria-hidden="true" />
                    ...
                    <div className="p-4 bg-green-50/40">
                        <h4 className="text-sm font-semibold text-green-900 mb-3">NCM Delivery Details</h4>
                        ...
                        <div className="grid sm:grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-semibold">
                                    {deliveryTypes.find(d => d.value === ncmOrder!.delivery_type)?.label ?? ncmOrder!.delivery_type}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="font-semibold">Rs. {ncmOrder!.delivery_charge}</p>
                            </div>
