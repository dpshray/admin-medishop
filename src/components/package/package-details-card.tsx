      ...
      <Card className="overflow-hidden border-border shadow-lg hover:shadow-xl transition-all duration-300 py-0">
        <CardHeader className="space-y-4 bg-gradient-to-br from-purple-50 via-purple-50/80 to-background p-5 sm:p-7 sm:space-y-6 sm:pb-9 border-b">
          ...
          >
            <div
              ...
              role="listitem"
            >
              <span className="text-xs font-semibold text-gray-600 sm:text-sm uppercase tracking-wide">
                Price:
              </span>
              ...
              <Badge
                ...
                style={
                  status
                    ? {
                        background:
                          "linear-gradient(135deg, #4a358e 0%, #6b4db8 100%)",
                      }
                    : undefined
                }
              >
        ...
        {hasImages && (
          <CardContent className="space-y-5 p-5 sm:p-7 sm:space-y-6 bg-gradient-to-b from-gray-50/50 to-white border-b">
            <div className="flex items-center gap-2.5 border-b border-gray-200 pb-3.5">
              ...
              <h2 className="text-lg font-bold sm:text-xl text-gray-900">
                Package Images
              </h2>
            </div>
            ...
            <div className="grid gap-5 sm:grid-cols-2 sm:gap-6">
              {featured_image && (
                <div className="space-y-2.5">
                  <p className="text-xs font-semibold text-gray-600 sm:text-sm uppercase tracking-wide">
                    Featured Image
                  </p>
        ...
        <CardContent className="space-y-5 p-5 sm:p-7 sm:space-y-6">
          <div className="flex items-center gap-2.5 border-b border-gray-200 pb-3.5">
            ...
            <Badge
              variant="secondary"
              className="ml-auto text-xs sm:text-sm font-bold shadow-sm px-3"
            >
