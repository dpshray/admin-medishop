...
export default function VendorForm({
    ...
    useEffect(() => {
        if (initialData) {
            Object.entries(initialData).forEach(([key, value]) => {
                if (value != null) {
                    setValue(key as keyof FormValues, value as any, {shouldValidate: false})
                }
            })
        }
    ...
    const handleAccountStatusToggle = useCallback((checked: boolean) => {
                            ...
                            <CardContent className="space-y-8">
                                        ...
                                        {[
                                            ...
                                            <div key={name} className="space-y-3">
                                                <FileInputField
                                                    ...
                                                    helperText={existingFile ? "Replace existing document" : "Allowed: PNG, JPG, JPEG"}
                                                />
                                ...
                                <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-200">
                                    ...
                                    <Button
                                        ...
                                        disabled={isSubmitting}
                                        aria-label={isEditMode ? "Update vendor" : "Create new vendor"}
                                    >
                                        {isSubmitting ? (
                                            <>
