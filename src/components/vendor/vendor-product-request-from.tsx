...
const VendorProductRequestForm = () => {
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                {availableVariations.map((variation,index) => {
                                                    ...
                                                    return (
                                                        <Button
                                                            type="button"
                                                            key={`available-${variation.id} + ${variation.name} + ${variation.size_value} + ${variation.size_unit} + ${index}`}
...
export default VendorProductRequestForm