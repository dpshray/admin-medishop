...
export const updateVendorSchema = z.object({
    ...
    alternate_email: z.string().email("Invalid alternate email").optional().or(z.literal("")),
    mobile_number: z.string().min(1, "Mobile number is required").optional(),
    bank_account_holder_name: z.string().min(1, "Bank account holder name is required").optional(),
    ...
    municipality: z.string().min(1, "Municipality is required").optional(),
